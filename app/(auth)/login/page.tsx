    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-100 via-rose-50 to-rose-200 flex items-center justify-center px-4">
      <div className="w-full max-w-[680px] text-center">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h2 className="mt-5 text-2xl font-semibold text-gray-700">Login</h2>
          <div className="w-16 h-[3px] bg-red-400 mt-2 rounded-full"></div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm text-gray-500 px-1">
            ...
            <button className="text-gray-700 font-medium hover:text-red-400 transition-colors">Forgot password?</button>
          </div>

          <button className="w-full bg-[#eb5b5b] hover:bg-[#df4f4f] text-white font-bold py-4 rounded-lg tracking-widest transition">LOGIN</button>

          <p className="text-gray-500 text-sm">
            Don&apos;t have an account?{" "}
            <Link href="/register" className="font-semibold text-gray-700 hover:text-red-400">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
